...
const DeleteModal = () => {
  ...
  const openModal = () => {
    setIsOpen(true);  // Set the state to open the modal
  };
  ...
  return (
    <>
      ...
      <div className="flex justify-center m-5">
        <button
          onClick={openModal} // Open the modal with the function
      ...
      {isOpen && (
        <div
          id="deleteModal"
          className="fixed inset-0 z-50 flex justify-center items-center overflow-x-hidden overflow-y-auto"
          aria-hidden="true"
        >
          <div className="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              <button
                onClick={closeModal}  // Close the modal with the function
